...
Homme() {
  return (
    ...
    <div className='flex flex-col  items-center  justify-center  p-5 '>
        <div className='flex  items-center justify-center text-xl font-semibold bg-[#343434] w-[395px] h-12 rounded-lg'>Pic your favorite genre </div>
      ...
      <div className='bg-slate-800 w-44 p-2 text-2xl mt-6 font-semibold text-center rounded-lg items-center justify-center '>Top Matches</div>
    </div>
  )
}
